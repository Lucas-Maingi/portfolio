...
export const alt = "Lucas Maingi — AI Engineer building agentic systems and LLM applications";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ color: "#a3a3a3", fontSize: 34, marginTop: 24, lineHeight: 1.3 }}>
            Agentic systems, LLM tooling & applied machine learning
          </div>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div style={{ color: "#737373", fontSize: 24 }}>
            LLM eval · AI agents · fintech payments · LLM security · AIOps
          </div>
